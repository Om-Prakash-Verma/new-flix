  ...
  return (
    <div className="container max-w-4xl py-12">
      ...
      <div className="space-y-6 text-foreground/80">
        ...
        <p>
          We respect copyright and intellectual property rights. If you believe any content infringes your rights, please see our <Link href="/legal/dmca" className="text-primary hover:underline">DMCA page</Link>.
        </p>
